...
// Initialize services
const connection = new web3_js_1.Connection(process.env.HELIUS_RPC_URL || 'https://api.mainnet-beta.solana.com');
const feeService = new feeCollectionService_1.FeeCollectionService(connection);
...
router.get('/usage/stats', async (req, res) => {
    try {
        ...
        const stats = usageService.getUsageStats(timeframe);
        res.json({
            success: true,
            data: stats,
            timeframe,
