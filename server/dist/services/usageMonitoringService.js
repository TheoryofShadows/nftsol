...
exports.UsageMonitoringService = void 0;
class UsageMonitoringService {
    constructor() {
        this.metrics = [];
        this.maxMetrics = 50000; // Keep last 50k metrics in memory
    ...
    getUniqueUsersInTimeframe(metrics) {
        const users = new Set();
        metrics.forEach(m => {
            if (m.userId) {
                users.add(m.userId);
...
exports.UsageMonitoringService = UsageMonitoringService;
