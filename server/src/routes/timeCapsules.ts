...
import { TimeCapsuleSalesService } from '../services/timeCapsuleSales';

const router = Router();
const timeCapsuleService = new TimeCapsuleSalesService();
...
router.get('/upcoming', async (req, res) => {
  try {
    ...
    const sales = await timeCapsuleService.getUpcomingReleases(parseInt(hours as string));
