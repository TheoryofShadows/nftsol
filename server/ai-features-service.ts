...
// Exported so other modules (like monitoring dashboards) can display usage
// statistics and enforce the same rate limits consistently.
...
// Exported for shared visibility across the server modules.
