...
$env:PORT = "3001"
$env:CLOUT_PROGRAM_ID = "26iJ37BE3icVtoo2QRkfjtYXFHMudG2sbTHAnhF2D6ab"
$env:REWARDS_VAULT = "7SBYHw5KQasPKajH6gCDnpWmb5QAh9EBvTi3cUnFAc1v"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd 'C:\Users\KHK89\NFTSol\apps\backend'; `$env:PORT='3001'; `$env:CLOUT_PROGRAM_ID='26iJ37BE3icVtoo2QRkfjtYXFHMudG2sbTHAnhF2D6ab'; `$env:REWARDS_VAULT='7SBYHw5KQasPKajH6gCDnpWmb5QAh9EBvTi3cUnFAc1v'; `$env:NODE_ENV='development'; Write-Host '🚀 Starting NFTSol Backend...' -ForegroundColor Green; Write-Host 'CLOUT_PROGRAM_ID: ' `$env:CLOUT_PROGRAM_ID -ForegroundColor Cyan; Write-Host 'REWARDS_VAULT: ' `$env:REWARDS_VAULT -ForegroundColor Cyan; npm run dev" -WindowStyle Normal
...
try {
    ...
    if ($progs.data.programs.CLOUT_PROGRAM_ID) {
        ...
        if ($progs.data.programs.CLOUT_PROGRAM_ID -eq "26iJ37BE3icVtoo2QRkfjtYXFHMudG2sbTHAnhF2D6ab") {
