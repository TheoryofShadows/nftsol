# 🎨 Complete Minting Guide - NFTSol

Welcome! This guide walks you through creating your first NFT on NFTSol, whether from the Archive or your own content.
...
2. [Traditional NFT Minting](#traditional-nft-minting)
3. [Archive-Based NFT Minting](#archive-based-nft-minting)
4. [Eternal Echoes (Collaborative NFTs)](#eternal-echoes-collaborative-nfts)
5. [Costs & Fees](#costs--fees)
6. [Verification with Grok](#verification-with-grok)
7. [Listing for Sale](#listing-for-sale)
8. [FAQ](#faq)
...
- ✅ **5-10 minutes**: Time to complete the process

### Step 1: Connect Your Wallet

1. Click **"Connect Wallet"** button in the top-right corner
2. Select your wallet type (Phantom, Solflare, Ledger, etc.)
3. Approve the connection in your wallet extension
4. You should see your wallet address displayed (like `abc...xyz`)

> **Tip**: If you don't have a wallet yet, download [Phantom Wallet](https://phantom.app) and create a new one. It takes 2 minutes!

---

## Traditional NFT Minting

### Method 1: Upload Your Own Content

**Timeline**: 5-10 minutes to mint + 2-10 minutes verification
...
- Review:
  ...
  - Year created
  - License type (should be "public-domain" or CC-licensed)
...
- **Royalty**: Percentage for creator + you get CLOUT bonus!
...
- You receive **CLOUT tokens** for:
  ...
  - ✅ Getting sales/engagement (+1 CLOUT per sale)
- Your CLOUT can be:
...
└─ Echo Layer 1: "Colorful visualizer animation" (Artist A)
   └─ Echo Layer 2: "Extended dubstep remix" (DJ B)
      └─ Echo Layer 3: "Hologram effect rendering" (Technologist C)

When someone buys the Echo NFT:
- Original Artist: 50% (specified royalty)
- Echo Layers: Split 40% (by contribution)
- Platform: 10%
- You (curator): Included in contributor rewards
```
...
- They can submit contributions via:
  ...
  - Smart contracts (code-based art)
...
- When sold:
  ...
  - All future resales also split by contribution
...
Mint Echo NFT → Pay gas (~0.001 SOL)
List for 5 SOL → Pay gas (~0.001 SOL)

When sold for 5 SOL:
- Original creator: 2.5 SOL (50% royalty)
- 5 echo contributors: Split 2 SOL (40% for collaboration)
- Platform: 0.5 SOL (10%)
- You get: Your share of contributors + CLOUT rewards
```
...
- ✅ Creates permanent verification record on-chain
...
- 🎯 Better discoverability (verified first in search)
...
- **70-89%**: Likely authentic, minor concerns
  - Example: "Content quality is good, metadata needs verification"
- **50-69%**: Mixed signals, needs review
  - Example: "Content has some AI-enhanced elements"
- **Below 50%**: Potential issues detected
  - Example: "Detected possible manipulation, recommend re-upload"
...
- **Grok verification**: Compares against original to verify consistency
...
✅ Ensure your wallet has SOL for gas fees (~0.001 SOL)
✅ Verify your NFT metadata is correct
✅ Consider competitive pricing
✅ Plan your royalty percentage

### How to List:

1. Go to **"My NFTs"** tab
2. Find your unminted NFT
3. Click **"List for Sale"**
4. Enter:
   - **Price** (in SOL)
   - **Royalty %** (5-25% recommended)
   - **Duration** (how long the listing is active)
5. Click **"Confirm Listing"**
6. Approve transaction in wallet
7. **Wait 10-20 seconds** for confirmation
...
- **Echo Collaborations**: 2-10+ SOL (collaborative premium)
...
A: 1-2 minutes for transaction confirmation. With optional Grok verification: 5-10 minutes total.

**Q: Can I change the price after listing?**
A: Yes! Go to your NFT, click "Update Listing", and set new price.
...
If issue persists, contact support with transaction hash.

**Q: Can I delete/unlist my NFT?**
A: Yes, click "Unlist" on your NFT card. It stays in your collection but isn't for sale.
...
- Echo contributions: +2-5 CLOUT per layer
...
A: Click "Connect Wallet" again and approve in your wallet extension.
...
4. Check your account in the explorer (solscan.io)
...
1. **For Best Results**:
   - Use high-quality images/videos (720p+)
   - Write detailed, compelling descriptions
   - Add relevant tags
   - Verify with Grok (even if archive item)
   - Research competitive pricing

2. **Archive Minting Specific**:
   - Choose unique items (not already minted)
   - Add historical context in description
   - Give credit to original source
   - Mention Internet Archive provenance
   - Make it about curation value
...
4. **Marketing Your NFT**:
   - Share on Twitter/X
   - Post in Discord communities
   - Explain why it's valuable
   - Show before/after (for echoes)
   - Engage with buyers and collectors
...
- 📧 **Email Support**: support@nftsol.app (coming soon)
